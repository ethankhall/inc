...
pub mod test {
    ...
    foo:
        ...
        assert_eq!(
            foo_commands.get(0).unwrap(),
            &Commands::CommandList(String::from("bar"))
        );
        assert_eq!(
            foo_commands.get(1).unwrap(),
            &Commands::CommandList(String::from("baz"))
        );
    ...
    foo:
        ...
        let config_container = ConfigContainer {
            project_config: vec![
                ConfigWithPath::no_file(yaml1),
                ConfigWithPath::no_file(yaml2),
                ConfigWithPath::no_file(yaml3),
            ],
            home_config: ConfigWithPath::no_file(HomeConfig {
        ...
        assert_eq!(
            foo_command.get(0),
            Some(&Commands::CommandList(String::from("bar1")))
        );
        assert_eq!(
            foo_command.get(1),
            Some(&Commands::CommandList(String::from("baz1")))
        );
        ...
        assert_eq!(
            bar_command.get(0),
            Some(&Commands::CommandList(String::from("bar2")))
        );
        assert_eq!(
            bar_command.get(1),
            Some(&Commands::CommandList(String::from("baz2")))
        );
        ...
        assert_eq!(
            baz_command.get(0),
            Some(&Commands::CommandList(String::from("bar3")))
        );
        assert_eq!(
            baz_command.get(1),
            Some(&Commands::CommandList(String::from("baz3")))
        );
        assert_eq!(
            baz_command.get(2),
            Some(&Commands::CommandList(String::from("flig3")))
        );
    }
}
