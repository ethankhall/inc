...
mod test {
    ...
    fn will_accept_ssh_url() {
        ...
        assert!(is_git_url(ScmUrl::from("ssh://host.xz/path/to/repo.git")));
        assert!(is_git_url(
            ScmUrl::from("ssh://ethall@host.xz/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://ethall@host.xz/path/to/repo.git"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://host.xz:111/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://host.xz:111/path/to/repo.git"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://ethall@host.xz:111/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://ethall@host.xz:111/path/to/repo.git"),
        ));
        ...
        assert!(is_git_url(
            ScmUrl::from("ssh://host.xz/~ethall/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://host.xz/~ethall/path/to/repo.git"),
        ));
        assert!(is_git_url(ScmUrl::from(
        ...
        assert!(is_git_url(
            ScmUrl::from("ssh://host.xz:111/~ethall/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ssh://host.xz:111/~ethall/path/to/repo.git"),
        ));
    ...
    fn will_accept_git_url() {
        ...
        assert!(is_git_url(ScmUrl::from("git://host.xz/path/to/repo.git")));
        assert!(is_git_url(
            ScmUrl::from("git://host.xz:111/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("git://host.xz:111/path/to/repo.git"),
        ));
    ...
    fn will_accept_http_url() {
        ...
        assert!(is_git_url(
            ScmUrl::from("https://host.xz/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("http://host.xz:222/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("https://host.xz:222/path/to/repo.git/"),
        ));
    }
    ...
    fn will_accept_ftp_url() {
        ...
        assert!(is_git_url(
            ScmUrl::from("ftp://host.xz:222/path/to/repo.git/"),
        ));
        assert!(is_git_url(
            ScmUrl::from("ftps://host.xz:222/path/to/repo.git/"),
        ));
    }
